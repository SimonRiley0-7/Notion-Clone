...
export const Item = ({
    ...
    return (
        <div
            ...
            className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex item-center text-muted-foreground font-medium",
                ...
                {!!id && (
                    <div className="ml-auto flex items-center gap-x-2">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-30" align="start" side="right" forceMount>
