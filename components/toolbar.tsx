        ...
        <div className="pl-[54px] group relative">
            {!!initialData.icon && !preview && (
                <div className="flex items-center gap-x-2 group/icon pt-6">
                    ...
                    <Button onClick={onRemoveIcon} className="rounded-full opactiy-0 group-hover/icon:opacity-100 transistion text-muted-foreground text-xs" variant="outline" size="icon">
                        <X className="h-4 w-4"/>
                    </Button>
                </div>)}
                {!!initialData.icon && preview && (
